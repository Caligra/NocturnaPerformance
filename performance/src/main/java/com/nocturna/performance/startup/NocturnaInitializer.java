...
import com.nocturna.performance.metafields.ShopifyMetafieldService;
...
public class NocturnaInitializer implements ApplicationRunner {
    ...
    public NocturnaInitializer(CatalogService catalogService, HolleyBrandsRepository brandsRepository, HolleyProperties holleyProperties, ShopifyMetafieldService metafieldService, TranslateService translateService) {
